...
Object.defineProperty(Config.prototype, 'decoding', {
    get: function () {
      return bindings.lame_get_decode_only(this._gfp);
    }
  , set: function (v) {
      var rtn = bindings.lame_set_decode_only(this._gfp, v);
    }
  , enumerable: true
});
